    ...
    <div class="tw-flex-col">
      ...
      if (have_posts()):
        while (have_posts()) :
          the_post();
      ?>
          <div class="tw-flex tw-flex-col md:tw-flex-row-reverse" style="border-bottom: 1px solid #000;">
            <div class="md:tw-basis-1/2">
              <?php the_post_thumbnail(); ?>
            </div>

            <div class="event-info tw-flex tw-flex-col tw-place-content-between tw-p-5 md:tw-basis-1/2">
              ...
              <div class="bottom tw-flex-col">
                <div class="tw-overflow-hidden tw-text-wrap tw-text-ellipsis">
                  <h2><?php the_title(); ?></h2>
